import 'story.dart';  //Step 6 - import the story.dart file into this file.
...
//depending on the choice made by the user. e.g. if choiceNumber was equal to 1 and the 
//storyNumber is 0, the storyNumber should become 2.

//Step 22 - In nextStory() if the storyNumber is equal to 3 or 4 or 5, that means
// it's the end of the game and it should call a method called restart() that resets the
// storyNumber to 0.
...
//Step 27 - Create a method called buttonShouldBeVisible() which checks to see if
